...
small number of philosophers -- not interesting to statistical
analysis -- we developed a bootstrap method to generate
\emph{artifical philosophers}, representing the contemporaries
philosophers of the representatives chosen. Those contemporaries were
...
was generated, considering 500 new philosophers highly influenced by
...
random scores. Not just the size of dataset was considered when
including these \emph{artificial philosophers}, but a better
representation of how philosophy was developed. Along the history, a reduced
...
samples highly influenced by the originals. We considered $\sigma =
