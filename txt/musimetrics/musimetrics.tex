...
\title[Can the music be analyzed quantitatively?]{Can the music be analyzed quantitatively?}
...
%%% talvez aqui seria interessante relembrar os calculos, mostrando tambem as figuras
...
which can be disputed, but on the quantitative analysis techniques employed.
...
considering $\sigma = 1.1$. %%% FIXME: por que foi escolhido esse valor?
...
%% FIXME: explicar melhor o porque a media dos desviso sendo baixa garante o metodo
